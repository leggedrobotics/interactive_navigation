...
It renames all the occurrences of interactive_navigation (in files, directories, etc.) to the new project name.
"""
...
if __name__ == "__main__":
    ...
    old_name = "interactive_navigation"
    new_name = sys.argv[1]
    ...
    if proceed.lower() == "y":
        # rename the interactive_navigation folder
        os.rename(
            os.path.join(root_dir_path, "exts", "interactive_navigation", "interactive_navigation"),
            os.path.join(root_dir_path, "exts", "interactive_navigation", new_name),
        )
        os.rename(os.path.join(root_dir_path, "exts", "interactive_navigation"), os.path.join(root_dir_path, "exts", new_name))
