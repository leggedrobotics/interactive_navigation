...
import interactive_navigation.tasks.locomotion.box_climb.mdp as mdp
...
class CommandsCfg:
    ...
    #     asset_name="robot",
    #     resampling_time_range=(1.0, 15.0),
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        velocity_commands = ObsTerm(func=mdp.generated_commands, params={"command_name": "goal_position_cmd"})
...
class EventCfg:
    ...
    reset_base = EventTerm(
        func=mdp.reset_robot_around_step,
        mode="reset",
        params={
...
class RewardsCfg:
    ...
    feet_air_time = RewTerm(
        ...
        params={
            ...
            "command_name": "goal_position_cmd",
            "threshold": 0.5,
        },
    )
...
@configclass
class LocomotionBoxStepEnvCfg(ManagerBasedRLEnvCfg):
